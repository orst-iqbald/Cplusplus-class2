...
{
public:
   Goblin() {type = "Goblin"; attack=0; defense=0; armor=3; strength =8; achilles = false;}
};
...
{
public:
   Reptile() {type = "Reptile"; attack =0; defense = 0; armor = 7; strength =8; achilles =false;}
};
class Blue:public Character
{
public:
   Blue() {type = "Blue"; attack =0; defense = 0; armor = 3; defense = 0; strength =12; achilles = false;}
...
{
public:
   Shadow() {type = "Shadow"; attack =0; defense= 0; armor = 0; strength = 12; achilles = false;}
   virtual void setAttack() 
        {attack = ((rand()%10 +1) + (rand()%10 +1));
       	        if(getAchilles() == true)
                attack = attack/2;
